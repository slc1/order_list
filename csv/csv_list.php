...
?>
	...
	<div class="metabox-holder has-right-sidebar">		
					...
					<p>Здесь производиться экспорт и импорт списка товаров в формате CSV. Выберите из таблицы ниже, с какой группой товаров Вы хотите производить операции экспорта или импорта. </p>			
                    <table class="widefat">
			 	     <thead>
					    <tr>
												<th>Название</th>
                     ...
                     ?>
                       <tr>
								<td><a href="admin.php?page=<?php echo dirname(plugin_basename(__FILE__)); ?>/csv.php&csv_action=csv_item&item_id=<?php echo $mysql_result['id']; ?>" class="more-common"><?php echo $mysql_result['title'] ?></a></td>
...
echo  $yourcat->name ;} } else echo "Нет" ?></td>
								...
								<td><a href="admin.php?page=<?php echo dirname(plugin_basename(__FILE__)); ?>/csv.php&csv_action=csv_item&item_id=<?php echo $mysql_result['id']; ?>" class="more-common">Перейти к экспорту импорту</a></td> 
					   </tr>
					 <?php  } ?>	
				<tfoot>
					    <tr>
