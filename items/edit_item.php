        ...
        <form method="post" action="admin.php?page=<?php echo dirname(plugin_basename(__FILE__)); ?>/items.php">
				<table class="form-table">
					...
					<th scope="row" valign="top">Название товара<em class="required">Обязательно</em></th>
						<td>
							<input class="input-text" name="item_title" value="<?php echo $mysql_result['title'] ?>" type="text"/>
					...
					<th scope="row" valign="top">Ярлык товара</th>
						<td>
							<input class="input-text" name="item_slug" value="<?php echo $mysql_result['slug'] ?>" type="text"/>
					...
					<th scope="row" valign="top">Название таксономи</th>
						<td>
							<input class="input-text" name="item_taxonomy" value="<?php echo $mysql_result['taxonomy'] ?>" type="text"/>
					...
					<th scope="row" valign="top">Ярлык таксономи</th>
						<td>
							<input class="input-text" name="item_taxonomy_slug" value="<?php echo $mysql_result['taxonomy_slug'] ?>" type="text"/>
            ...
            <table class="widefat">
				<thead>
					<tr>
                     ...
                     foreach ($mysql_results as $mysql_result) { $sql_array[]=$mysql_result; }
                     foreach ($sql_array as $mysql_result) {
                        $i++;
                     ?>
						   <tr class="">
								<td><a class="more-common" href="admin.php?page=<?php echo dirname(plugin_basename(__FILE__)); ?>/items.php&item_action=edit_item_field&item_id=<?php echo $item_id; ?>&field_id=<?php echo $mysql_result['id']; ?>"><?php echo $mysql_result['title']; ?></a></td>
								...
								<td><a class="more-common" href="admin.php?page=<?php echo dirname(plugin_basename(__FILE__)); ?>/items.php&item_action=edit_item_field&item_id=<?php echo $item_id; ?>&field_id=<?php echo $mysql_result['id']; ?>">Редактировать</a> | 
                                ...
                                <a class="more-common-delete" onclick="delete_field_<?php echo $mysql_result['id']; ?>();">Удалиить</a> 
                                <?php if (!($i==1)) { ?> 
                                | <a class="more-common" href="admin.php?page=<?php echo dirname(plugin_basename(__FILE__)); ?>/items.php&item_action=change_item_fields&item_id=<?php echo $item_id; ?>&field_id=<?php echo $mysql_result['id']; ?>&field_id1=<?php echo $sql_array[$i-2]['id']; ?>">↑</a> 
                                <?php  } ?>
                                <?php  if (!($i==$i_max)) { ?> | <a class="more-common" href="admin.php?page=<?php echo dirname(plugin_basename(__FILE__)); ?>/items.php&item_action=change_item_fields&item_id=<?php echo $item_id; ?>&field_id=<?php echo $mysql_result['id']; ?>&field_id1=<?php echo $sql_array[$i]['id']; ?>">↓</a> 
                                <?php  } ?>
                                </td>
							</tr>
                     <?php } ?>       
				<tfoot>
					<tr>
					<th colspan="8">
					<p><a class="button-primary" href="admin.php?page=<?php echo dirname(plugin_basename(__FILE__)); ?>/items.php&item_action=add_item_field&item_id=<?php echo $item_id; ?>">Добавить поле</a></p>					</th>
					</tr>
				</tfoot>
			</table>
<br /><br />
			...
			<input class="button" value="Редактировать" type="submit"/>	&nbsp; <a class="button-primary" href="admin.php?page=<?php echo dirname(plugin_basename(__FILE__)); ?>/items.php">Отмена</a>		
			</form>
