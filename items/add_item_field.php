            ...
            <form method="post" action="#">
                <table class="form-table">
                    ...
                    <tr class="">
                        ...
                        <td>
                            <label><input class="input-radio" name="field_type" value="text" checked="checked"
                                          type="radio"/> Text</label>
                            ...
                            <label><input class="input-radio" name="field_type" value="select" type="radio"/>
                                Select</label>
                            <em>Создается выпадающий список. Для него обязательно заполнение предопределенных
                                значений.</em>
                            <label><input class="input-radio" name="field_type" value="radio" type="radio"/>
                                Radio</label>
                            ...
                            <label><input class="input-radio" name="field_type" value="number_int" type="radio"/> Number
                                Integer</label>
                            <em>Поле для целых числовых значений -2147483648 to 2147483647. При вводе проводится
                                валидация.</em>
                            <label><input class="input-radio" name="field_type" value="number" type="radio"/>
                                Number</label>
                            ...
                            <em>Поле для ввода даты. Должно быть в формате YYYY-mm-dd, например <code>2010-07-10</code>.
                                При вводе проводится валидация.</em>
