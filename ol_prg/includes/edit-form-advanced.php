...
?>
				...
				<textarea name="<?php echo $columns[$i]["field"]?>" size="30" tabindex="1" style="width:100%;height:<?php echo $columns[$i]["height"]; ?>;"><?php echo $textcontent?></textarea>
...
?>
	<div class="jcl_label"><?php echo $columns[$i]["header"]?></div>
	<input type="text" style="width:100%"<?php if ($columns[$i]["readonly"]=="readonly") echo 'readonly="readonly"'; ?> name="<?php echo $columns[$i]["field"]?>" value="<?php echo esc_attr( htmlspecialchars( $post->$columns[$i]["field"] ) ); ?>" id="titlex" autocomplete="off" />
