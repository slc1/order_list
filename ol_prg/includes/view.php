...
<form name="post" action="admin.php?page=<?php echo $this_table_obj->pluginprefix.$this_table_obj->pluginname?>/<?php echo $this_table_obj->pluginname?>.php" method="post" id="post">
