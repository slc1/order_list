...
/**
 * Edit Posts modified for stop press ффф
 *
 * @package WordPress
...
<div class="wrap">
    ...
    <form id="jcl-posts-filter" class="edit_form_<?php echo $this_table_obj->pluginname ?>"
          action="admin.php?page=<?php echo ORDER_LIST_PLUGIN_SLUG ?>"
          method="post" onsubmit="javascript:doSubmit();">
        ...
        <div class="tablenav">
            ...
            <div class="alignright">
                <input class="button-primary" type="button" value="Добавить запись"
                       onclick="javascript:addNewRecord();"/>
            </div>
            <div class="clear"></div>
        </div>
